...
from lrimmich.catalog import read_collections, read_flagged_images
...
def run_sync(
    ...
    resolved = resolve_paths(all_paths, cfg.path_map, client, on_progress=on_progress)
    if on_status:
    ...
    if cfg.sync.albums:
        ...
        try:
            album_actions = plan_album_sync(
                ...
                state,
                client,
                share_with=cfg.share_albums_with,
                safety=cfg.safety,
                force=force,
                no_delete=no_delete,
    ...
    if cfg.sync.favorites:
        ...
        try:
            flagged = read_flagged_images(cfg.catalog)
